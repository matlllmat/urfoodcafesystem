<!-- Edit Product Modal -->
<div id="editProductModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center p-4">
    <div class="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <!-- Header -->
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <div>
                <h2 class="text-title text-xl">Edit Product</h2>
                <p id="editProductSubtitle" class="text-regular text-sm text-gray-500">Update product details and recipe</p>
            </div>
        ...
        <div class="flex-1 overflow-y-auto p-6">
            <form id="editProductForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0">
                            <img id="editProductImagePreview" src="../assets/images/product/default-product.png" alt="Product preview" class="w-32 h-32 object-cover rounded-lg border border-gray-300">
                        </div>
                        <div class="flex-1">
                            <input type="file" id="editProductImageInput" accept="image/*" class="hidden">
                            <button
                                type="button"
                ...
                <!-- Product Name -->
                <div>
                    <label for="editProductName" class="block text-product text-gray-700 mb-2">Product Name *</label>
                    <input
                        type="text"
                        id="editProductName"
                        required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="editProductPrice" class="block text-product text-gray-700 mb-2">Selling Price (&#8369;) *</label>
                        <input
                            type="number"
                            id="editProductPrice"
                            required
                    ...
                    <div>
                        <label for="editProductStatus" class="block text-product text-gray-700 mb-2">Status *</label>
                        <select
                ...
                <div>
                    ...
                    <div id="editProductCategoriesContainer" class="border border-gray-300 rounded-md p-4 max-h-48 overflow-y-auto">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <p class="text-label text-gray-500 mb-4">Update inventory items needed to make this product</p>

                    <!-- Requirements Rows Container -->
                    <div id="editProductRequirements" class="space-y-3">
                        <!-- Dynamic rows will be populated here -->
                    </div>

                    <!-- Add Requirement Button -->
                    <button type="button" onclick="addRequirementRow('edit')"
                    ...
                    <!-- Cost Preview -->
                    <div id="editProductCostPreview" class="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            <span class="text-regular text-gray-700">Estimated Cost:</span>
                            <span id="editProductEstimatedCost" class="text-regular text-gray-800 font-medium">&#8369;0.00</span>
                        </div>
                        <div class="flex items-center justify-between mt-1">
                            <span class="text-label text-gray-500">Estimated Profit:</span>
                            <span id="editProductEstimatedProfit" class="text-label text-gray-600">&#8369;0.00</span>
                        </div>
                    </div>
                </div>
            </form>
